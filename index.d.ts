...
interface NodeModule {
    exports: any;
    require: NodeJS.RequireFunction;
    id: string;
    filename: string;
    loaded: boolean;
...
declare namespace NodeJS {
    ...
    export namespace Stream {
        ...
        export class Transform extends EventEmitter implements NodeJS.ReadWriteStream {
            readable: boolean;
            writable: boolean;
    ...
    export namespace StringDecoder {
    ...
    export namespace DomainNode {
        export class Domain extends EventEmitter implements NodeJS.Domain {
            run(fn: Function): void;
    ...
    interface RequireFunction {
        ...
        (id:"querystring"):typeof QueryString;
        (id:"stream"):typeof Stream;
        (id:"net"):typeof Net;
        (id:"http"):typeof Http;
        (id:"zlib"):typeof Zlib;
        (id:"os"):typeof Os;
        (id:"crypto"):typeof Crypto;
        (id:"tls"):typeof Tls;
        (id:"https"):typeof Https;
        (id:"url"):typeof Url;
        (id:"dns"):typeof Dns;
        (id:"dgram"):typeof Dgram;
        (id:"fs"):typeof Fs;
        (id:"util"):typeof Util;
        (id:"path"):typeof Path;
        (id:"string_decoder"):typeof StringDecoder;
        (id:"tty"):typeof Tty;
...
declare module "buffer" {
    export = NodeJS.Buffer;
}

declare module "querystring" {
    export = NodeJS.QueryString;
}
...
declare module "crypto" {
    export = NodeJS.Crypto;
}

declare module "stream" {
    export = NodeJS.Stream;
}
...
declare module "domain" {
    export = NodeJS.DomainNode;
}

declare module "constants" {
    export = NodeJS.Constants;
}
