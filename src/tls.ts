...
import { SocketEvents as NetSocketEvents } from "./net";
import { ServerEvents as NetServerEvents } from "./net";

export declare var CLIENT_RENEG_LIMIT: number;
export declare var CLIENT_RENEG_WINDOW: number;
export type SocketEvents = NetSocketEvents & {
...
export declare class TLSSocket extends NetSocket {
    events: SocketEvents;
    /**
...
export declare function createServer(options: TlsOptions, secureConnectionListener?: (socket: TLSSocket) => void): Server;
export declare function connect(options: ConnectionOptions, secureConnectionListener?: () => void): TLSSocket;
export declare function connect(port: number, host?: string, options?: ConnectionOptions, secureConnectListener?: () => void): TLSSocket;
export declare function connect(port: number, options?: ConnectionOptions, secureConnectListener?: () => void): TLSSocket;
...
Object.assign(module.exports, require('tls'));